...
contract BuyMeCoffee {
     ...
     */
    function buyMeCoffee(string memory _title, string memory _message)
        public
        payable
    {
        ...
        coffee.push(
            Coffee(_title, _message, msg.sender, msg.value, block.timestamp)
        );
        totalCoffe += 1;
        emit NewOneIsBuyingCoffe(
            _title,
            _message,
            msg.sender,
            msg.value,
